...
<body>
  ...
  <h3>请选择一级课程：</h3><br>
	...
	<br><br><br>
	<input type="button" value="二级课程名称" class="text2"/><input type="text" name="second.second_name" class="text1" value="${second.second_name}"><br><br><br>
	<input type="submit" value="更&nbsp;&nbsp;新" class="text3">
